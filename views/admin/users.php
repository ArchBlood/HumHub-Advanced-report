...
/**
 * @var \humhub\modules\report\models\ReportUser $report;
...
<div class="container-fluid">
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><strong>Users</strong> reported</div>
        <div class="panel-body">

        <?php if (empty($reports)) : ?>
            <br/> <br/>
            <?= Yii::t('ReportModule.widgets_views_reportContentAdminGrid', 'There are no reported users.') ?>
            <br/> <br/>
        <?php else : ?>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function($report) {
                        $userLink = Html::a(Html::encode($report->reportedUser->displayName), $report->reportedUser->getUrl());
                        return Html::tag('strong', $userLink .' created '. TimeAgo::widget(['timestamp' => $report->reportedUser->created_at]), ['class' => 'media']);
                    }
                ],
                [
                    'class' => DataColumn::class,
                ...
                [
                    ...
                    'value' => function($report) {
                        $approve = ModalConfirm::widget([
                            ...
                            'linkHref' => Url::to(["//report/report/appropriate", 'id' => $report->id, 'resource' => 'user']),
                        ]);

                        $review =  Html::a('<i aria-hidden="true" class="fa fa-eye"></i>', $report->reportedUser->getUrl(), [
